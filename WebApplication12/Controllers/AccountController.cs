...
using WebApplication12.ViewModels; // пространство имен моделей RegisterModel и LoginModel
using WebApplication12.Models; // пространство имен UserContext и класса User
...
namespace WebApplication12.Controllers
{
    ...
    {
        private fridgeContext db;
        public AccountController(fridgeContext context)
        {
            db = context;
        }
        [HttpGet]
